...
public class StickyLayout extends LinearLayout {
    ...
    private void initData() {
        int headerId= getResources().getIdentifier("more_activity_sticky_header", "id", getContext().getPackageName());
        int contentId = getResources().getIdentifier("more_activity_sticky_content", "id", getContext().getPackageName());
